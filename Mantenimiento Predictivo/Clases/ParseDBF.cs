        ...
        public static DataTable ReadDBF(string dbfFile)
        {
            ...
            try
            {
                ...
                foreach (FieldDescriptor field in fields)
                {
                    ...
                    switch (field.fieldType)
                    {
                        case 'N':
                            ...
                            {
                                col = new DataColumn(field.fieldName, typeof(decimal));//int
                            }
                            break;
                        case 'C':
                        ...
                        case 'D':
                            ...
                            break;
                        case 'L':
                            col = new DataColumn(field.fieldName, typeof(bool)); //bool
                            break;
                        case 'F':
                            col = new DataColumn(field.fieldName, typeof(decimal)); //Double
                            break;
                    }
                    dt.Columns.Add(col);
                }
                ...
                for (int counter = 0; counter <= header.numRecords - 1; counter++)
                {
                        ...
                        switch (field.fieldType)
                        {
                            case 'N':  // Number
                                ...
                                if (IsNumber(number))
                                {
                                    ...
                                    {
                                        row[fieldIndex] = decimal.Parse(number); //int
                                        //row[fieldIndex] = 3.4;
                                    }
                                }
                                else
                            ...
                            case 'F':
                                ...
                                if (IsNumber(number))
                                {
                                    //row[fieldIndex] = decimal.Parse(number); //double
                                    string s1;
                                    string s2;
                                    int n = number.Length;
                                    s1 = number.Substring(0, n - 2);
                                    s2 = number.Substring(n - 2, 2);
                                    string S = s1 + "," + s2;
                                    row[fieldIndex] = decimal.Parse(S);
                                    //row[fieldIndex] = 3.4;
                                }
                                else
                                {
                    ...
                    /*
                    Se agrega este code para que elimine las fechas distintas
                     * 
                     * SECO ACA ES 
                     * ESTAS LINEAS DE ABAJOOOOOOOOOOOOO
                     * BAREBANA!!!!!
                    ...
                    */
                    ...
                    else if ((row[0].Equals(row_ant[0])))
                    {
